...
export class EntertainmentDataService {
  ...
  getSeries() {
    return this.entertainmentData.filter(
  ...
  getBookmarkedMovies() {
    return this.entertainmentData.filter(
      (bookmarkedMovies) =>
        bookmarkedMovies.category === 'Movie' &&
        bookmarkedMovies.isBookmarked === true
    );
  }
  ...
  getBookmarkedSeries() {
    return this.entertainmentData.filter(
      (bookmarkedSeries) =>
        bookmarkedSeries.category === 'TV Series' &&
        bookmarkedSeries.isBookmarked === true
    );
  }

  getTrendingMovies() {
    return this.entertainmentData.filter(
      (trendy) => trendy.isTrending === true
    );
  }
